...
5. **Tenant isolation.** Every query is scoped to a workspace. Schema-per-tenant in Postgres; no cross-tenant joins; tests must prove isolation for every new table.
